    ...
    <Row>
      ...
      <Control>
        ...
        >
          ...
          <Dropdown.Item value="midori-blue">Blue And Orange</Dropdown.Item>
          <Dropdown.Item value="midori-lavender">Purple and Yellow</Dropdown.Item>
          <Dropdown.Item value="midori-red_and_green">Green and Red</Dropdown.Item>
        </Dropdown>
      </Control>
    </Row>
  );
